...
│   ├── test_converters_core.py     # Shared conversion logic tests (UnifiedMessage, merging, payload assembly)
...
│   ├── test_parsers.py             # AwsEventStreamParser tests (JSON truncation diagnostics, stop-reason frames)
│   ├── test_routes_anthropic.py    # Anthropic API endpoint tests (/v1/messages, WebSearch, Account System failover)
│   ├── test_routes_openai.py       # OpenAI API endpoint tests (/v1/chat/completions, WebSearch, Account System failover)
